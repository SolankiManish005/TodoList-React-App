...
function App() {
  ...
  return (
    <>
    <Navbar/>
     <div className="mx-3 md:conatainer md:mx-auto my-5 rounded-xl p-5 bg-violet-100 min-h-[80vh] md:w-1/2">
          ...
          <div className="todos">
            ...
            {todos.map(item=>{
              return (showFinished || item.isCompleated) &&  <div key={item.id} className="todo flex my-3 justify-between">
                <div className='flex gap-5'>
                    <input name={item.id} onChange={handleCheckbox} type="checkbox" checked={item.isCompleated}/>
